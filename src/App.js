...
function App() {
  ...
  const [currentBoardID, setCurrentBoardID] = useState([2]);
  ...
  return (
    <div className="App">
      ...
      <h1>Current Board: {currentBoardID}</h1>
      ...
      <NewCardForm handleCardSubmit={handleCardSubmit} currentBoardID={currentBoardID} />
